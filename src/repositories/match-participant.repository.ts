...
import {MatchParticipant, MatchParticipantRelations, Athlete, Team, Match} from '../models';
...
> {
  ...
  public readonly match: BelongsToAccessor<Match, typeof MatchParticipant.prototype.id>;

  constructor(
    @inject('datasources.kyo_db') dataSource: KyoDbDataSource, @repository.getter('AthleteRepository') protected athleteRepositoryGetter: Getter<AthleteRepository>, @repository.getter('TeamRepository') protected teamRepositoryGetter: Getter<TeamRepository>, @repository.getter('MatchRepository') protected matchRepositoryGetter: Getter<MatchRepository>,
  ) {
